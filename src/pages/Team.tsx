...
import { Plus, Users, Mail, Trash2, Loader2, UserCog } from 'lucide-react';
...
import type { Membership, AppRole } from '@/types';
...
const roleColors: Record<AppRole, string> = {
  agency_admin: 'bg-accent text-accent-foreground',
  company_owner: 'bg-info text-info-foreground',
  company_staff: 'bg-muted text-muted-foreground',
};
...
export default function Team() {
  ...
  useEffect(() => {
    if (currentCompany) fetchMembers();
  }, [currentCompany]);
      ...
      <div className="flex justify-between items-center">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            <Button className="bg-accent hover:bg-accent/90"><Plus className="h-4 w-4 mr-2" /> Add Member</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
